...
public class Imp2LibTest {
    ...
    public void testAddStudentMember(String studentId, String studentName) {
        try {
            ...
            if (studentId.isEmpty() || studentName.isEmpty()) {
                assert(e instanceof LibraryException);
            } else {
                assert(e instanceof LibraryException);
            }
        }
    ...
    @Property
    public void checkExtend() throws LibraryException {
    ...
    @Property
    public void checkExtendOnce() throws LibraryException {
        Library library = new Library();
        library.addStudentMember("st1", "124");
        library.addStudentMember("st2", "123");
        library.addBook("Batman", 2);
    ...
    @Property
    public void checkNoExtend() throws LibraryException {
        Library library = new Library();
        library.addStudentMember("st1", "124");
        library.addStudentMember("st2", "123");
        library.addBook("Batman", 2);
    ...
    @Property
    public void checkExtendBeforeBorrow() throws LibraryException{
        Library library = new Library();
        library.addStudentMember("st1", "124");
        library.addBook("Batman", 2);
    ...
    @Property
    public void checkExtendForMagazine() throws LibraryException {
        Library library = new Library();
        library.addStudentMember("st1", "124");
    ...
    @Property
    public void checkPenaltyForReferenceBook() throws LibraryException {
        Library library = new Library();
        library.addStudentMember("st1", "124");
        ...
        penalty = library.getTotalPenalty("124");
        expectedPenalty = (3 * 5000) + (2 * 7000); // 3 days * 5000 + 2 days * 7000
        assertEquals(expectedPenalty, penalty);

    }

    @Property
    public void checkPenaltyForOrdinaryBook() throws LibraryException {
        Library library = new Library();
        library.addStudentMember("st1", "124");
        ...
        penalty = library.getTotalPenalty("124");
        expectedPenalty = (7 * 2000) + (7 * 3000); // 7 days * 2000 + 7 days * 3000
        assertEquals(expectedPenalty, penalty);

        library.timePass(10); // 24 days late in total

        penalty = library.getTotalPenalty("124");
        expectedPenalty = (7 * 2000) + (14 * 3000) + (3 * 5000); // 7 days * 2000 + 14 days * 3000 + 3 days * 5000
        assertEquals(expectedPenalty, penalty);
    ...
    @Property
    public void testPenaltyForMultipleBooks()throws LibraryException {
    ...
    @Property
    public void checkPenaltyForMagazineBefore1390() throws LibraryException {
        Library library = new Library();
        library.addStudentMember("st1", "124");
    ...
    @Property
    public void checkPenaltyForMagazineAfter1390() throws LibraryException {
        Library library = new Library();
        library.addStudentMember("st1", "124");
    ...
    @Property
    public void testProfessorBorrowLimit() throws LibraryException {
        Library library = new Library();
    ...
    @Property
    public void testStudentBorrowLimit() throws LibraryException{
        Library library = new Library();
    ...
    @Property
    public void testMultipleCopiesAvailability() throws LibraryException {
        Library library = new Library();
