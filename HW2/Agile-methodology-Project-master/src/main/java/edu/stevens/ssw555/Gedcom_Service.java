...
public class Gedcom_Service {
	...
	public static void readAndParseFile(String fileName) throws IOException {
	...
	public static void Nulify() {
		families = new HashMap<String, Family>();
		individuals = new HashMap<String, Individual>();
		sdf = new SimpleDateFormat("MM/dd/yyyy");
		fileName = null;
		dupInd = new ArrayList<Individual>();
		dupFam = new ArrayList<Family>();
	}
	//UserStory 03 implementation
	//Refactored code for method

	public static void birthBeforeDeath(HashMap<String, Individual> individuals) throws FileNotFoundException, IOException {
	...
	//Refactored code for method
	public static void Marriagebeforedivorce(HashMap<String, Individual> individuals, HashMap<String, Family> families)
	...
	public static void birthbeforemarriageofparent(HashMap<String, Individual> individuals, HashMap<String, Family> families)
			throws FileNotFoundException, IOException {
		Date marriageDate = null;
		Date divorceDate = null;
		Date birthDate = null;
...
//UserStory 16 Implementation
	public static void Malelastname(HashMap<String, Family> families)
	...
	public static void AuntsandUnclesname(HashMap<String, Family> families)
			throws ParseException, FileNotFoundException, IOException {
